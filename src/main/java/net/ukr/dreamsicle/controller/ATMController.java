...
public class ATMController {
    ...
    @GetMapping("/atms")
    public Page<AtmDTO> findAll(String first, String second, @PageableDefault(sort = {"id"}, direction = Sort.Direction.ASC) Pageable page) {
        return atmService.search(first, second, page);
    }
